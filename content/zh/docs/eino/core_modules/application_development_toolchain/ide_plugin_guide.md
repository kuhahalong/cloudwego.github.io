...
>
> Eino 是 Go AI 集成组件的研发框架，提供了 AI 应用相关的常用组件以及集成组件编排能力，为了更好的辅助开发者使用 Eino，我们提供了 **GoLand Eino IDE 插件**，现在就[安装插件](/zh/docs/eino/core_modules/application_development_toolchain/ide_plugin_guide)，助你高效开发 🚀
...
<table><tbody><tr>
<td>
1. 点击「+」，填入**https://fornax.bytedance.net/api/fe-plugin/jet-brains.xml**，点击确定
<img src="/img/eino/HXVib7Y0Oo6merxvcJNcR8cHnQb.png" />
</td>
<td>
1. 进入「Marketplace」，搜索**Eino**，点击安装并**重启**IDE
