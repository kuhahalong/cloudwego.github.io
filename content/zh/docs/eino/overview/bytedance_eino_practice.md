...
<tr>
<td>Workflow<br/></td><td>字段级别流转数据的有向无环图，适合需要灵活配置数据映射关系的场景。<br/></td></tr>
</table>
...
wf.AddLambdaNode("l1", lambda1).AddInput("model", FromTo("Content", "Input"))
wf.AddLambdaNode("l2", lambda2).AddInput("model", FromTo("Role", "Role"))
wf.AddLambdaNode("l3", lambda3).
    AddInput("l1", FromTo("Output", "Query")).
    AddInput("l2", FromTo("Output", "MetaData"))
wf.AddEnd("l3")
...
<tr>
<td>EinoDev 插件<br/>(Goland)<br/></td><td>非必须<br/></td><td>- 可视化拖拽编排 AI 应用，并生成全码<br/>- 可视化对编排的 AI 应用进行调试<br/>- EinoDev 暂只有 Goland 版，后续会提供 VSCode 版<br/></td><td>// TODO：使用手册<br/>// TODO: 安装使用教程<br/><br/></td></tr>
<tr>
<td> 火山云豆包模型/向量化<br/></td><td>必须<br/></td><td>- 豆包模型：ArkChatModel，提供在线的对话文本推理能力<br/>- 向量化：将文本进行向量化计算，用于对 Eino 知识库构建向量索引<br/><br/></td><td>「火山引擎豆包模型」：<br/>- https://console.volcengine.com/ark/region:ark+cn-beijing/endpoint?config=%7B%7D<br/>- 需要实名认证后购买使用，每人有 50万免费Tokens额度<br/>![](/img/eino/J8EYb4QZ2oyauGxkwzncXdLFnwe.png)<br/></td></tr>
<tr>
<td>Docker<br/></td><td>非必须<br/></td><td>- 通过 Docker 提供 RedisSearch 组件<br/>- 也可自主进行手动部署<br/></td><td>// TODO: 安装使用教程链接<br/></td></tr>
<tr>
<td>Eino 智能助手代码示例<br/></td><td>必须<br/></td><td><br/></td><td><br/></td></tr>
</table>

### 索引知识库

> 示例的仓库路径：[https://github.com/cloudwego/eino-examples/tree/feat/eino_assistant/quickstart/eino_assistant](https://github.com/cloudwego/eino-examples/tree/feat/eino_assistant/quickstart/eino_assistant)
>
...
火山引擎是字节跳动的基础设施服务平台，源于字节在大模型上的大量投入，豆包大模型资源可从火山平台上唾手可得，有大量免费额度可供使用。
...
1. 安装 EinoDev 插件，并打开 Eino Workflow 功能
   ...
   - Output type: []string
   - 其他置空
     ![](/img/eino/PYEpbbQ5moCAwUxl4nVcLH3Jnxg.png)
...
<table><tbody><tr>
<td>
<img src="/img/eino/HkGLbMARioQuIHxNljQcMOJDnCg.png" />
</td>
<td>
<img src="/img/eino/O13BbuatPoUPD7x0Buscn3UNnue.png" />
</td>
</tr></tbody></table>
...
<table><tbody><tr>
<td>
<img src="/img/eino/CvLQbDS19op967xwtTyc2MCTnee.png" />
</td>
<td>
<img src="/img/eino/V5o4beZUSoYk5Vxa6YZcXYHtnPh.png" />
</td>
</tr></tbody></table>
...
![](/img/eino/EATIbspgSogIwGxhYaScXJ5bnqh.png)
...
<table><tbody><tr>
<td>
<img src="/img/eino/ZbZEbTFKFoDiXtx0sH2cBH8QnSu.png" />
</td>
<td>
<img src="/img/eino/NFShbeA2fodjqfxTVk0cxmMJnbb.png" />
</td>
</tr></tbody></table>
...
<table><tbody><tr>
<td>
<img src="/img/eino/Kzmjb5tgWovm9PxnqjwcRIL9nph.png" />
</td>
<td>
<img src="/img/eino/K3jrb2ddnoiNitxzyC4cLMjAn0e.png" />
</td>
</tr></tbody></table>
...
![](/img/eino/K7TWbRuIyoGhkRxDWC6c7w7mnpe.png)
